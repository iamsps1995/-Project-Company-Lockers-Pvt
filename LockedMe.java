...
static final String projectPath="D:\\java project\\import folder";
	...
	public static void displayMenu() {
		...
		System.out.println("\tDeveloper Name : Shailesh Singh");
		System.out.println("*******************************");
	...
	public static void createFiles()
	{
		try {
			...
			System.out.println("enter how many line you want to add");
		int	linesCount=Integer.parseInt(obj.nextLine());
			...
			{
				System.out.println("Enter file content lines;");
